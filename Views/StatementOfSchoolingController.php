...
require_once 'Reports/Reports/StatementOfSchoolingReport.php';

class StatementOfSchoolingController extends Portabilis_Controller_ReportCoreController
{
    /**
     * @var int
     */
     ...
     * @var string
     */
    protected $_titulo = 'Relatório Atestado de Escolaridade';
...
//        $this->report->addArg('modelo', (int) $this->getRequest()->modelo);
    ...
    /**
     * @return StatementOfSchoolingReport
     *
     * @throws Exception
     */
    public function report()
    {
        return new StatementOfSchoolingReport();
    }
