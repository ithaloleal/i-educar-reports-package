...
require_once 'Reports/Reports/ServantsAllocationsSectorReport.php';

class ServantsAllocationsSectorController extends Portabilis_Controller_ReportCoreController
{
    /**
     * @var int
     */
     ...
     * @var string
     */
    protected $_titulo = 'Relatório servidores por setor';
    ...
    protected function _preRender()
    {
        ...
        $this->breadcrumb('Relatório servidores por setor', [
...
//        $this->report->addArg('vinculo', (int) $this->getRequest()->vinculo_id);
    ...
    /**
     * @return ServantsAllocationsSectorReport
     *
     * @throws Exception
     */
    public function report()
    {
        return new ServantsAllocationsSectorReport();
    }
}
